...
( codigo tinyint not null,
  nombre varchar(40) not null,
  constraint pk_grupo primary key (codigo))ENGINE=InnoDB DEFAULT CHARSET=utf8;

create table ingrediente
( codigo smallint not null,
  nombre varchar(40) not null,
  constraint pk_ingrediente primary key (codigo))ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert into ingrediente values (4,'BRÓCOLI');
insert into ingrediente values (5,'PATATAS');
insert into ingrediente values (6,'SAL');
insert into ingrediente values (7,'AZÚCAR');
...
insert into ingrediente values (17,'SETAS');
insert into ingrediente values (18,'PIMIENTOS');
insert into ingrediente values (19,'AJO PUERRO');
...
insert into ingrediente values (31,'LIMÓN');
insert into ingrediente values (32,'MEMBRILLO');
insert into ingrediente values (33,'ACEITE');
insert into ingrediente values (34,'LUBINA');
insert into ingrediente values (35,'CURRY');
insert into ingrediente values (36,'MANZANAS');
insert into ingrediente values (37,'PIÑA');
insert into ingrediente values (38,'ESPINACAS');


insert into editorial values (1,'Paraninfo');
insert into editorial values (2,'Garceta');
insert into editorial values (3,'Ra-ma');
insert into editorial values (4,'Anaya');
insert into editorial values (5,'Santillana');
insert into editorial values (6,'Mc-Graw-Hill');
insert into editorial values (7,'Susaeta');


insert into chef values (1,'JULIAN','CONDE','FLORES','JULIANICO','H','1969-5-6','NIGRÁN','36');
insert into chef values (2,'MARIA','MAGADÁN','PÉREZ','MAMA MAGA','M','1973-12-6','MONFORTE','27');
insert into chef values (3,'FELIPE','ARIAS','CONDE','FELIPIN','H','1964-1-1','PONTEVEDRA','36');
insert into chef values (4,'JUAN','GARCÍA','BARREIRO','EL TITO','H','1973-11-9','LUGO','27');
insert into chef values (5,'MIRIAM','LÓPEZ','SIERRA','MIRINDA','M','1959-4-4','SANTIAGO','15');
insert into chef values (6,'ROSA','REDONDO','RUIZ','ROSITA','M','1965-3-2','SANTIAGO','15');
...
insert into chef values (9,'CARLOS','DIEGUEZ','RODRÍGUEZ','CARLIÑOS','H','1969-8-5','NEGREIRA','15');
...
insert into libro values (1,'Recetas para adelgazar',2,11,220);
insert into libro values (2,'Cocina internacional',3,10,250);
insert into libro values (3,'Cocina para principiantes',1,7,100);
insert into libro values (4,'Recetas para adelgazar',2,11,220);
insert into libro values (5,'Cupcakes',6,5,50);
insert into libro values (6,'Pasión por el chocolate',5,10,120);
insert into libro values (7,'Fácil y rápido',3,6,135);
insert into libro values (8,'Recetas gallegas',4,9,155);
insert into libro values (9,'Aperitivos',1,8,175);
insert into libro values (10,'Objetivo adelgazar',1,8,175);


INSERT INTO receta VALUES (1,'ARROZ AL COMINO',3,'Media',50,'Se rehoga en aceite el ajo puerro con ....',11);
INSERT INTO receta VALUES (2,'PIMIENTOS RELLENOS',5,'Difícil',80,'Se asan los pimientos ....',11);
INSERT INTO receta VALUES (3,'PELO BLANCO',2,'Difícil',45,'Se cuecen los garbanzos en ....',8);
INSERT INTO receta VALUES (4,'TALLARINES VERDES',4,'Fácil',25,'Se cuecen los tallarines en agua salada y ...',6);
INSERT INTO receta VALUES (5,'PASTA CON SETAS',4,'Media',45,'Se pone a ...',6);
INSERT INTO receta VALUES (6,'LUBINA A LA SAL',7,'Fácil',30,'Precalentar el forno a ...',3);
INSERT INTO receta VALUES (7,'FRESAS A LA PIMIENTA DE JAMAICA',9,'Fácil',15,'Lavar las fresass y',11);
INSERT INTO receta VALUES (8,'TORTA DE MANZANA',9,'Media',60,'Mezclar la harina ..',4);
INSERT INTO receta VALUES (9,'QUESO CON PIÑA',1,'Fácil',15,'Se corta la ..',7);
INSERT INTO receta VALUES (10,'ALMEJAS VERDES',9,'Difícil',90,'Se cuecen las ...',1);
INSERT INTO receta VALUES (11,'MEJILLONES RELLENOS',9,'Difícil',80,'Se cuecen los ...',3);
INSERT INTO receta VALUES (12,'HUEVOS DULCES',1,'Media',30,'Se cuecen los ...',5);
INSERT INTO receta VALUES (13,'FRESAS CON NATA',9,'Fácil',20,'Batir la ...',9);
INSERT INTO receta VALUES (14,'SOLOMILLO A LA PIMIENTA',6,'Fácil',20,'Se ...',10);
