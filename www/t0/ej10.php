...
<form method="post" action="">
    ...
    <input type="text" id="texto" name="texto" value="<?php echo isset($_POST['texto']) ? htmlspecialchars($_POST['texto']) : 'Sin problema'; ?>" required><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<p>1.4. Caracteres con ASCII 65, 66 y 67: " . chr(65) . chr(66) . chr(67) . "</p>";
