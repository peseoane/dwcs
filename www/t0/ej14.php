...
function reverse_string_recursive($str) {
    if (mb_strlen($str, 'UTF-8') <= 1) {
        ...
        return reverse_string_recursive(mb_substr($str, 1, null, 'UTF-8')) . mb_substr($str, 0, 1, 'UTF-8');
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<p>Texto original: " . htmlspecialchars($input_string, ENT_QUOTES, 'UTF-8') . "</p>";
    echo "<p>Texto invertido: " . htmlspecialchars($reversed_string, ENT_QUOTES, 'UTF-8') . "</p>";
}
?>
</body>
</html>