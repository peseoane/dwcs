...
use clases\Grupos as group;
use clases\Participantes as participants;
...
<html>
    ...
    <body>
        ...
        echo $base->show();
        $grupo = new group($nom, $nif, $direc, $web);
        echo $grupo->show();
        $participante = new participants($nom, $nif, $direc, $mail, $telf, $grupo, $fechaIniGrupo);
